...
function buildMainWithExtras(MAIN){
  ...
  const EXTRA_MAP = {
    '07-09': { name:'Дополнительная трасса (за 1 м) 07–09', unit:'м.п.', price:1500 },
    '12':    { name:'Дополнительная трасса (за 1 м) 12',     unit:'м.п.', price:1700 },
    '18':    { name:'Дополнительная трасса (за 1 м) 18',     unit:'м.п.', price:1700 }
  };
...
function wireCalcInputs(){
  document.querySelectorAll('.calc-table input[type="number"]').forEach(inp => {
